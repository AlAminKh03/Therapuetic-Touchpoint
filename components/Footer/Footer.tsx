    ...
    <div className='mt-28 md:mx-14 bg-gray-50 p-[70px]'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 '>
            ...
            <div >
                ...
                <FaFacebookSquare className='text-center text-xl hover:text-blue-600'/>
                <FaTwitter className='text-center text-xl hover:text-blue-600'/>
                </div>
                <div className='mt-5 flex justify-center'>
                <Link href="#" className='px-3 text-xs'>privacy policy</Link>
                <Link href="#" className='px-3 text-xs'>Returns policy</Link>
                <Link href="#" className='px-3 text-xs'>Terms of service</Link>
                </div>
            </div>
        </div>
    </div>
