      ...
      <div>
        ...
        <div className="flex justify-start ml-6">
          <div>
            <Link
              href="/appointment"
              className="uppercase rounded-xl  items-center border bg-black text-white  mt-4 hover:translate-x-1 transition-all ease-in duration-500 flex justify-evenly gap-2"
            >
