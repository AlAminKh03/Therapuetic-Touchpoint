      ...
      <div className=" relative grid grid-cols-1 md:flex flex-row-reverse justify-center px-12 md:px-24 items-center ">
        ...
        <div className=" md:mx-auto flex md:pr-32 flex-col mt-4">
          <h1 className="font-light text-3xl ">
            ...
            <br /> Simplifying the Medical Appointment Process!
          </h1>
          <p className="py-6 text-sm leading-6 text-gray-800 tracking-wider">
            Getting a doctor&rsquo;s appointment in public or private hospitals
            can be a hassle due to long wait times and overbooked schedules.
            Booking an appointment can also be time-consuming. Despite these
            challenges, prioritize your health and seek medical attention when
            necessary. Alternative options such as telemedicine or finding a
            primary care physician may help streamline the process.
          </p>
